  ...
  function fn_contact() {
    ...
    $form.validate({
      ...
      submitHandler: function(form) {
        ...
        $(form).ajaxSubmit({
          type: 'POST',
          url: "https://formspree.io/hello@joinbenefit.com",
          dataType: 'json',
          cache: false,
          data: $form.serialize(),
          success: function(data) {
            ...
            $formNotify.removeClass('valid error').addClass('valid').html('<i class="fa fa-check-square"></i> Thank you, we will be in touch shortly.').show();
          },
          error: function(data) {
            ga('send', 'event', {
              eventCategory: 'Form',
...
// --------------------------------------------------
  ...
  $('#glasses-field, #dental-field, #physio-field, #chiro-field').barrating({
    theme: 'bars-pill',
    showValues: true,
    allowEmpty: true,
    initialRating: '',
...
// --------------------------------------------------
  ...
  $('[data-show-user-form]').on('click', function () {
    var $userFormSection = $('#user-form-section');

    // Save the form type onto the hidden input element, i.e. "single", "couple",
    // "family"
    var formType = $(this).data('show-user-form');
    var $formTypeField = $userFormSection.find('[name="form-type"]');
    $formTypeField.val(formType);

    // Show form section
    $userFormSection.collapse('show');
  ...
  function fn_userForm() {
    ...
    $form.validate({
      ...
      errorPlacement: function(error, element) {},
      highlight: function(element) {
        $(element).parent('.form-group').addClass('error has-error');
      },
      unhighlight: function(element) {
        $(element).parent('.form-group').removeClass('error has-error');
      },
      submitHandler: function(form) {
        ga('send', 'event', {
          eventCategory: 'Form',
          eventAction: 'submit',
          eventLabel: 'User Form'
        });
